...
### 请先点 :star: 
## 🔄 最新更新
* [2025/03/26] 完善了加混响功能[Add reverb](https://github.com/shuaijiang/Whisper-Finetune/docs/robust_asr.md#Add-reverb)，提升语音识别的鲁棒性。
...
* [2024/11/18] 新增谱增强[SpecAugment](https://github.com/shuaijiang/Whisper-Finetune/docs/robust_asr.md#SpecAugment)功能，有效提升语音识别的鲁棒性。
